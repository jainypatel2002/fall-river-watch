...
export function GigForm({
  ...
  const defaultValues = useMemo<GigFormValues>(
    () => ({
      ...
      city: initialGig?.city ?? "Fall River",
      state: initialGig?.state ?? "MA",
      zip: initialGig?.zip ?? "",
  ...
  return (
    <form className="space-y-5" onSubmit={form.handleSubmit((values) => void handleSubmit(values))}>
      <div className="grid gap-4 sm:grid-cols-2">
        ...
        <div className="space-y-2 sm:col-span-2">
          <Label htmlFor="gig-location-name">Location Name</Label>
          <Input id="gig-location-name" placeholder="Kennedy Park area" {...form.register("location_name")} />
        ...
        <div className="space-y-2">
          ...
          <Input id="gig-street" {...form.register("street")} />
        </div>
        <div className="space-y-2">
          <Label htmlFor="gig-city">City</Label>
          <Input id="gig-city" {...form.register("city")} />
        </div>
        <div className="space-y-2">
          <Label htmlFor="gig-state">State</Label>
          <Input id="gig-state" {...form.register("state")} />
        </div>
        <div className="space-y-2">
          <Label htmlFor="gig-zip">ZIP (optional)</Label>
          <Input id="gig-zip" {...form.register("zip")} />
        </div>

        <div className="space-y-2">
          <Label htmlFor="gig-lat">Latitude (optional)</Label>
          <Input id="gig-lat" placeholder="41.70" {...form.register("lat")} />
          {form.formState.errors.lat ? <p className="text-xs text-rose-300">{form.formState.errors.lat.message}</p> : null}
        </div>
        <div className="space-y-2">
          <Label htmlFor="gig-lng">Longitude (optional)</Label>
          <Input id="gig-lng" placeholder="-71.15" {...form.register("lng")} />
