export const queryKeys = {
  ...
  gigs: (filtersKey: string) => ["gigs", filtersKey] as const,
  gigDetail: (id: string) => ["gig-detail", id] as const,
  gigPosts: (userId: string) => ["gig-posts", userId] as const,
  gigApplications: (userId: string) => ["gig-applications", userId] as const,
  gigChatThread: (threadId: string) => ["gig-chat-thread", threadId] as const,
  gigChatMessages: (threadId: string) => ["gig-chat-messages", threadId] as const,
